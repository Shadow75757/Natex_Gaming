/*
  This script uses Modernizr to check browser capabilities.
  If supported, it initializes the PacMan game; otherwise, 
  it informs the user to use a more modern browser for a 
  better experience. The game elements are expected in an
  element with the ID "pacman".
*/
